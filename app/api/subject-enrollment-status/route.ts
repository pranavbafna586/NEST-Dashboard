    ...
    `;
        ...
        const funnelData = [
            { stage: "Screening", count: screening, percentage: 100 },
            {
                stage: "Enrolled",
                count: enrolled,
                percentage: screening > 0 ? Math.round((enrolled / screening) * 100) : 0
            },
            {
                stage: "On Trial",
                count: onTrial,
            ...
            },
            {
                ...
                percentage: followUp > 0 ? Math.round((totalCompleted / followUp) * 100) : 0
            },
        ];
        ...
        return NextResponse.json({
            ...
            totals: {
                totalSubjects: screening + enrolled + onTrial + followUp + totalCompleted + screenFailure + discontinued,
