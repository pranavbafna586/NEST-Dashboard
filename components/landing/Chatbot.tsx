...
export default function Chatbot() {
    ...
    const [messages, setMessages] = useState<Message[]>([
        {
            id: "welcome",
            text: "Hello! I'm your CTIE assistant. How can I help you today?",
            sender: "bot",
            timestamp: new Date(),
        },
    ]);
    ...
    const handleMicClick = useCallback(() => {
        if (!isSpeechSupported) {
            setSpeechError("Voice input is not supported in your browser. Please try Chrome or Edge.");
            setTimeout(() => setSpeechError(null), 5000);
            return;
        }
        toggleListening();
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200 bg-gradient-to-r from-blue-600 to-cyan-600">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-white font-semibold text-sm">CTIE Assistant</h3>
                                ...
                                {isHistoryOpen && (
                                    ...
                                    >
                                        <div className="px-4 py-3 border-b border-gray-100">
                                            <h4 className="font-semibold text-gray-800 text-sm">Chat History</h4>
                                        </div>
